...
window.foodDatabase = [
  ...
  // Beverages - Erweitert
{ name: 'wasser', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'wasser mit zitrone', kcal: 4, kh: 1, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'mineralwasser', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'kaffee', kcal: 2, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'kaffee mit milch', kcal: 11, kh: 1, fett: 1, eiweiss: 1, chol: 3, kategorie: 'beverages' },
{ name: 'cappuccino', kcal: 46, kh: 5, fett: 2, eiweiss: 3, chol: 8, kategorie: 'beverages' },
{ name: 'espresso', kcal: 1, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'schwarzer tee', kcal: 1, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'grüner tee', kcal: 1, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'coca cola zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'cola zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'pepsi zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'fanta zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'sprite zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'eistee zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'eistee pfirsich zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'eistee zitrone zero', kcal: 0, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'coca cola', kcal: 42, kh: 11, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'cola', kcal: 42, kh: 11, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'fanta', kcal: 45, kh: 11, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'sprite', kcal: 40, kh: 10, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'eistee', kcal: 32, kh: 8, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'eistee pfirsich', kcal: 32, kh: 8, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'eistee zitrone', kcal: 32, kh: 8, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'limonade', kcal: 40, kh: 10, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'orangensaft', kcal: 45, kh: 10, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
...
{ name: 'multivitaminsaft', kcal: 47, kh: 11, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'red bull', kcal: 45, kh: 11, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'red bull zero', kcal: 3, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'red bull sugarfree', kcal: 3, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'monster energy', kcal: 50, kh: 13, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'monster zero', kcal: 3, kh: 0, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'collab', kcal: 7, kh: 0, fett: 0, eiweiss: 1.8, chol: 0, kategorie: 'beverages' },
{ name: 'collab drink', kcal: 7, kh: 0, fett: 0, eiweiss: 1.8, chol: 0, kategorie: 'beverages' },
{ name: 'milch', kcal: 47, kh: 5, fett: 2, eiweiss: 3, chol: 10, kategorie: 'dairy' },
{ name: 'vollmilch', kcal: 64, kh: 5, fett: 4, eiweiss: 3, chol: 14, kategorie: 'dairy' },
{ name: 'leichte vollmilch', kcal: 47, kh: 5, fett: 1.5, eiweiss: 3, chol: 8, kategorie: 'dairy' },
{ name: 'fettarme milch', kcal: 47, kh: 5, fett: 1.5, eiweiss: 3, chol: 8, kategorie: 'dairy' },
{ name: 'magermilch', kcal: 35, kh: 5, fett: 0.1, eiweiss: 3, chol: 2, kategorie: 'dairy' },
{ name: 'kakao', kcal: 83, kh: 10, fett: 3, eiweiss: 3, chol: 12, kategorie: 'dairy' },
{ name: 'hafermilch', kcal: 47, kh: 7, fett: 2, eiweiss: 1, chol: 0, kategorie: 'beverages' },
{ name: 'mandelmilch', kcal: 13, kh: 0, fett: 1, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'sojamilch', kcal: 33, kh: 2, fett: 2, eiweiss: 3, chol: 0, kategorie: 'beverages' },
{ name: 'bier', kcal: 43, kh: 3, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'wein rot', kcal: 85, kh: 2, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
{ name: 'wein weiss', kcal: 82, kh: 2, fett: 0, eiweiss: 0, chol: 0, kategorie: 'beverages' },
...
// Make globally accessible
window.getDefaultPortionSize = getDefaultPortionSize;
...
function populateFoodDatalist() {
  ...
  essenNameInput.addEventListener('input', (e) => {
    ...
    debounceTimer = setTimeout(() => {
      ...
      console.log(`📝 ${matches.length} Matches für "${searchTerm}"`);
    }, 300);
  });
