...
`;
    ...
    bonusLevels.forEach(l => {
        ...
        html += `
            <tr style="${rowStyle}">
  <td style="padding: 12px; border: 1px solid #ccc; color: #000000 !important; font-weight: 600 !important;">
    ${l.level}
</td>
    ...
    let html = `
        <div class="analysis-section">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--space-24); gap: var(--space-16); flex-wrap: wrap;">
                <button class="btn btn-secondary" onclick="navigateWeek(-1)" ${!canGoBack ? 'disabled' : ''}>◀ ◀</button>
...
function renderWochenanalyse() {
    ...
    if (!appState.viewedKw) {
        appState.viewedKw = 'KW46' // Standard: Aktuelle Woche;
